...
import oneocr.cli.*;
import oneocr.cli.improve.*;
import oneocr.cli.layout.*;
import static oneocr.cli.PagedOcrData.*;
...
public class PdfOcrCommand implements Callable<Integer> {
    ...
    public void setParentCommand(oneocr.cli.OcrTool parentCommand) {
